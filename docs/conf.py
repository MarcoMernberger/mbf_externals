...
module_dir = os.path.join(__location__, "../src/mbf_externals")
try:
...
try:
    from mbf_externals import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'mbf_externals-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'mbf_externals Documentation',
...
def setup(app):
    ...
    github_doc_root = "https://github.com/TyberiusPrime/mbf_externals"
